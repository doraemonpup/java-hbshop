...
//			System.err.println("Socket geschlossen");
	...
	@Override
	public void aktualisiereProduktDaten(Produkt p, int altID, String altName,
		...
		//Übertrage Produkt p:
		out.println(String.valueOf(p.getID()));
		out.println(String.valueOf(p.getProduktName()));
		out.println(String.valueOf(p.getProduktPreis()));
		out.println(String.valueOf(p.getProduktMenge()));
		out.println(String.valueOf(p.getProduktinhalt()));
		out.println(String.valueOf(p.getType()));
	...
	@Override
	public boolean fuegeProduktEin(int id, String name, float preis, int menge,int artikelinhalt, String type)throws ProduktExistiertBereitsException, IOException {
	...
	@Override
	public void setProduktMenge(Vector<GewaehltesProdukt> warenkorb)/////////
			throws Exception {		
	}
	@Override
