...
/**
 * Klasse zur Repraesentation eizelner Kunden, Attribute, Methode get-set
 */
...
public class Kunde {
	...
	public Kunde(String benutzername,String password,String email,String vorname,String nachname, String wohnort,int plz, String strasseNr){
	...
	public Kunde(String benutzername,String password,String email,String vorname,String nachname,String wohnort,int plz,String strUndHausnr,float umsatz){
